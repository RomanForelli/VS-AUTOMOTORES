            ...
            <section className='row justify-content-center' id='SectionTwo'>
                ...
                <div className='row col-12 m-3 justify-content-center text-center'>
                    ...
                    <div className="card-body">
                        ...
                        <Link href="https://auto.mercadolibre.com.ar/MLA-1283545472-chery-tiggo-3-16-4x2-luxury-l17-2018-_JM#position=7&search_layout=grid&type=item&tracking_id=e8f162df-59b3-418b-a9ae-cb6bc759e7df" className="btn btn-primary">Ver Detalles</Link>
                    </div>
                    </div>
                    <div className="card p-1 m-3" style={{width: '18rem'}}>
                    ...
                    <Link href="https://auto.mercadolibre.com.ar/MLA-1308346518-chevrolet-tracker-premier-at-2023-0km7-_JM#position=15&search_layout=grid&type=item&tracking_id=e8f162df-59b3-418b-a9ae-cb6bc759e7df" className="btn btn-primary">Ver Detalles</Link>
                    </div>
                    </div>
                    <div className="card p-1 m-3" style={{width: '18rem'}}>
                    ...
                    <Link href="https://auto.mercadolibre.com.ar/MLA-1254980144-toyota-etios-15-4-ptas-xls-4at-l18-2018-_JM#position=12&search_layout=grid&type=item&tracking_id=e8f162df-59b3-418b-a9ae-cb6bc759e7df" className="btn btn-primary">Ver Detalles</Link>
                    </div>
                    </div>
                </div>
